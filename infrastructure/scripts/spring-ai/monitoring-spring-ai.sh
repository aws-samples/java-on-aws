      ...
      "targets": [
        {
          ...
          "disableTextWrap": false,
          "editorMode": "builder",
          "expr": "topk(10, sum by(gen_ai_operation_name, gen_ai_system, gen_ai_request_model) (increase(gen_ai_client_operation_seconds_count{application=\"$application\", error=\"none\"}[\$__rate_interval])))",econds_count{application=\"$application\", error=\"none\"}[$__rate_interval])))",
          "fullMetaSearch": false,
          "hide": false,
          "includeNullMetadata": true,
          "instant": false,
