...
public class S3Repository {
    ...
    @Value("${jvm-ai-analyzer.s3.bucket}")
    private String bucket;

    @Value("${jvm-ai-analyzer.s3.prefix.analysis:analysis/}")
    private String analysisPrefix;

    @Value("${jvm-ai-analyzer.s3.prefix.profiling:profiling/}")
    ...
    String getAnalysisPrefix() { return analysisPrefix; }
    String getProfilingPrefix() { return profilingPrefix; }
}
