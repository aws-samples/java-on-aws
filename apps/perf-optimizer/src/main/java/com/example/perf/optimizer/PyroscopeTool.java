 ...
 * time window, on a specific profile type. Copied from perf-analyzer; used
 * here as a plain helper (called directly by OptimizerTools), NOT exposed as
 * an MCP tool. Direct Pyroscope query — no collector dependency (fits the
...
public class PyroscopeTool {
    ...
    /** Top-N hottest functions by self-time. profileType: "cpu" or "wall". */
