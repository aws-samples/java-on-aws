...
~/environment/java-on-aws/labs/unicorn-store/infrastructure/scripts/ws-containerize-run.sh
...
~/environment/java-on-aws/labs/unicorn-store/infrastructure/scripts/ws-deploy-eks-eksctl.sh
