...
mv  ~/environment/unicorn-store-spring/src/main/java/com/unicorn/store/config/WebConfig.java.opt ~/environment/unicorn-store-spring/src/main/java/com/unicorn/store/config/WebConfig.java