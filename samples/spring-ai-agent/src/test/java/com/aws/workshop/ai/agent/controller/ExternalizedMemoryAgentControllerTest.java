...
@WebMvcTest(ExternalizedMemoryAgentController.class)
class ExternalizedMemoryAgentControllerTest {
    ...
    void shouldHandleChatRequest() throws Exception {
        ...
        // When & Then
        mockMvc.perform(post("/ext-memory/chat")
    ...
    void shouldHandleChatStreamRequest() throws Exception {
        ...
        // When & Then
        mockMvc.perform(post("/ext-memory/chat/stream")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(request))
                .andExpect(status().isOk())
    ...
    void shouldUpdateModel() throws Exception {
        ...
        // When & Then
        mockMvc.perform(post("/ext-memory/model")
